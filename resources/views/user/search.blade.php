...
@section('content')
    @if(count($data))
            <h4 style="text-align: center">Hasil Pencarian <strong>{{$search}}</strong></h4>
        <div class="row" style="margin-top: -2%">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div style="margin: 0% 0% 0% 8%">
                            ...
                            <h6 style="margin: -10px 0px 10px 0px; font-size: 10px; color: grey"><i
            ...
            @endforeach
            @else
                <h4 style="text-align: center;">Hasil Pencarian <strong>{{$search}} </strong>tidak ditemukan.</h4>
            @endif
        </div>
@endsection
